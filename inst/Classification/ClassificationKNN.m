    ...
    function CVMdl = crossval (this, varargin)
      ...
      if (numel (varargin) > 0)
        ...
        switch lower (varargin {1})
          ...
          case 'leaveout'
            if (ischar (Value) && (strcmpi (lower (Value), 'on') || strcmpi (lower (Value), 'off')))
              leaveout = Value;
            else
              error ("ClassificationKNN.crossval: Value should be a either 'on' or 'off'.");
            endif
          case 'cvpartition'
...
%! assert (CVMdl.ModelParameters.NumNeighbors, 5)
%! assert (CVMdl.ModelParameters.Distance, "mahalanobis")
%! assert (class (CVMdl.Trained{1}), "ClassificationKNN")
%! assert (CVMdl.ModelParameters.DistParameter, obj.DistParamter)
%! assert (CVMdl.ModelParameters.Standardize, obj.Standardize)
%! assert (CVMdl.ModelParameters.DistanceWeight, obj.DistanceWeight)
%! assert (CVMdl.ModelParameters.NSMethod, obj.NSMethod)
%!test
%! CVMdl = crossval (obj, "KFold", 5);
%! assert (class (CVMdl), "ClassificationPartitionedModel")
%! assert (CVMdl.KFold, 5)
%! assert (CVMdl.Partition, cvpartition (size (x, 1), 'KFold', 5))
%! assert (CVMdl.ModelParameters.NumNeighbors, 5)
%! assert (CVMdl.ModelParameters.Distance, "euclidean")
%! assert (class (CVMdl.Trained{1}), "ClassificationKNN")
%! assert (CVMdl.ModelParameters.DistParameter, obj.DistParamter)
%! assert (CVMdl.ModelParameters.Standardize, obj.Standardize)
%! assert (CVMdl.ModelParameters.DistanceWeight, obj.DistanceWeight)
%! assert (CVMdl.ModelParameters.NSMethod, obj.NSMethod)
%!test
%! obj = fitcknn (x, y, "NumNeighbors", 5, "Standardize", true);
%! CVMdl = crossval (obj, "Holdout", 0.2);
%! assert (class (CVMdl), "ClassificationPartitionedModel")
%! assert (CVMdl.KFold, 10)
%! assert (CVMdl.Partition, cvpartition (size (x, 1), 'Holdout', 0.2))
%! assert (CVMdl.ModelParameters.NumNeighbors, 5)
%! assert (CVMdl.ModelParameters.Distance, "euclidean")
%! assert (class (CVMdl.Trained{1}), "ClassificationKNN")
%! assert (CVMdl.ModelParameters.DistParameter, obj.DistParamter)
...
%! assert (class (CVMdl), "ClassificationPartitionedModel")
%! assert (CVMdl.KFold, 10)
%! assert (CVMdl.Partition, cvpartition (size (x, 1), 'LeaveOut'))
%! assert (CVMdl.ModelParameters.NumNeighbors, 10)
%! assert (CVMdl.ModelParameters.Distance, "cityblock")
%! assert (class (CVMdl.Trained{1}), "ClassificationKNN")
%! assert (CVMdl.ModelParameters.DistParameter, obj.DistParamter)
%! assert (CVMdl.ModelParameters.Standardize, obj.Standardize)
%! assert (CVMdl.ModelParameters.DistanceWeight, obj.DistanceWeight)
...
%! assert (CVMdl.Partition, partition)
%! assert (CVMdl.ModelParameters.NumNeighbors, 10)
%! assert (CVMdl.ModelParameters.Distance, "cityblock")
%! assert (class (CVMdl.Trained{1}), "ClassificationKNN")
%! assert (CVMdl.ModelParameters.DistParameter, obj.DistParamter)
...
%!error<ClassificationKNN.crossval: Too few input arguments.> crossval ()
%!error<ClassificationKNN.crossval: Name-Value arguments must be in pairs.> ...
...
%!error<ClassificationKNN.crossval: Value should be a either 'on' or 'off'.> ...
%! crossval (ClassificationKNN (ones (4,2), ones (4,1)), "leaveout", 2)
%!error<ClassificationKNN.crossval: Value should be a 'cvpartition' object.> ...
%! crossval (ClassificationKNN (ones (4,2), ones (4,1)), "cvPartition", 4) 
